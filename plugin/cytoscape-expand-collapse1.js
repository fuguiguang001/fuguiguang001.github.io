(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.cytoscapeExpandCollapse = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(_dereq_,module,exports){
      ...
      var functions = {
        init: function () {
          ...
          function drawExpandCollapseCue(node) {
            ...
            node._private.data.IsGroup = true;
    ...
    function saveLoadUtilities(cy, api) {
      ...
      */
      ...
      function instanceStr(obj) {
        return obj && obj.instanceString && fn6(obj.instanceString) ? obj.instanceString() : null;
      };
      ...
      function elementOrCollection(obj) {
      ...
      return {
        ...
        loadJson: function (txt) {
          ...
          if (fileJSON.zoom != null && fileJSON.zoom !== _p.zoom) {
            cy.zoom(fileJSON.zoom);
          }

          if (fileJSON.pan) {
            if (fileJSON.pan.x !== _p.pan.x || fileJSON.pan.y !== _p.pan.y) {
              cy.pan(fileJSON.pan);
            }
          }
          
          if (fileJSON.data) {
            cy.data(fileJSON.data);
          }

          if (fileJSON.style) {
            cy.style().clear();
            cy.style(fileJSON.style);
          }
        ...
        saveJson: function (elems, filename) {
           ...
           */
          o.zoom = cy.zoom();
          o.style = cy.style().json();
          o.data = copy(cy.data());
          let options = _p.options;
          o.zoomingEnabled = _p.zoomingEnabled;
          o.userZoomingEnabled = _p.userZoomingEnabled;
          o.zoom = _p.zoom;
          o.minZoom = _p.minZoom;
          o.maxZoom = _p.maxZoom;
          o.panningEnabled = _p.panningEnabled;
          o.userPanningEnabled = _p.userPanningEnabled;
          o.pan = copy(_p.pan);
          o.boxSelectionEnabled = _p.boxSelectionEnabled;
          o.renderer = copy(options.renderer);
          o.hideEdgesOnViewport = options.hideEdgesOnViewport;
          o.textureOnViewport = options.textureOnViewport;
          o.wheelSensitivity = options.wheelSensitivity;
          o.motionBlur = options.motionBlur;
          o.multiClickDebounceTime = options.multiClickDebounceTime;
